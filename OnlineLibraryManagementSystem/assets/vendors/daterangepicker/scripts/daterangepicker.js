    ...
    u = function () {
        ...
        return t.patchCurrentLocale = function (t) {
            ...
            t.setFirstDayOfTheWeek = function (t) {
                var e;
                if (t = (t % 7 + 7) % 7, moment.localeData().firstDayOfWeek() !== t) return e = t - moment.localeData().firstDayOfWeek(),
            ...
            t.tz = function (t) {
                var e, n;
                return e = Array.prototype.slice.call(arguments, 0, -1),
                    n = arguments[arguments.length - 1],
                    moment.tz ? moment.tz.apply(null, e.concat([n])) : n && "utc" === n.toLowerCase() ? moment.utc.apply(null, e) : moment.apply(null, e)
            },
            t
    }(),
        c = function () {
        ...
        e = function () {
            ...
            return t.rotateArray = function (t, e) {
                ...
                t.uniqArray = function (t) {
                    var e, n, a, r;
                    for (r = [], n = 0, a = t.length; n < a; n++) e = t[n],
        ...
        $.fn.daterangepicker = function (t, e) {
            return null == t && (t = {}),
                this.each(function () {
                    var n;
                    if (n = $(this), !n.data("daterangepicker")) return t.anchorElement = n,
                        e && (t.callback = e),
                ...
                update: function (t, e, n) {
                    ...
                    return a = $(t),
                        ...
                        ko.ignoreDependencies(function () {
                            var t;
                            return a.data("daterangepicker").standalone() || (t = a.data("daterangepicker").single() ? u : u + " – " + o, a.val(t).text(t)),
        ...
        d = function () {
            function t() { }
            return t.allPeriods = ["day", "week", "month", "quarter", "year"],
                t.scale = function (t) {
                ...
                t.methods = ["scale", "showWeekDayNames", "nextPageArguments", "format", "title", "dimentions"],
        ...
        r = function () {
            ...
            return e.prototype.extend = function (t) {
                ...
                e.prototype._minDate = function (t) {
                    var e, n;
                    return t instanceof Array && (n = t, t = n[0], e = n[1]),
                ...
                e.prototype._startDate = function (t) {
                    return t || (t = moment().subtract(29, "days")),
                ...
                e.prototype._ranges = function (e) {
                    ...
                    r = [];
                    for (c in e) switch (l = e[c]) {
                        case "all-time":
                            r.push(new t(c, this.minDate().clone(), this.maxDate().clone()));
                            break;
                        case "custom":
                            r.push(new i(c));
                            break;
                        default:
                            if (!$.isArray(l)) throw new Error("Value should be an array");
                            if (s = l[0], n = l[1], !s) throw new Error("Missing start date");
                            if (!n) throw new Error("Missing end date");
                            if (a = u.tz(s, this.timeZone()), d = u.tz(n, this.timeZone()), !a.isValid()) throw new Error("Invalid start date");
                            if (!d.isValid()) throw new Error("Invalid end date");
                            r.push(new o(c, a, d))
                    }
                    return r
                },
                ...
                e.prototype._dateObservable = function (t, e, n, a) {
                    ...
                    return s = ko.observable(),
                        ...
                        n && (r.minBoundary = n, n.subscribe(function () {
                            return r(s())
                        })),
        ...
        n = function () {
            function t(t) {
                this.clickNextButton = p(this.clickNextButton, this),
                    ...
                    this.prevDate = ko.pureComputed(function (t) {
                        return function () {
                            var e, n, a;
                            return a = t.period.nextPageArguments(),
                                e = a[0],
                                n = a[1],
                                t.currentDate().clone().subtract(e, n)
                        }
                    }(this)),
                    this.nextDate = ko.pureComputed(function (t) {
                        return function () {
                            var e, n, a;
                            return a = t.period.nextPageArguments(),
                                e = a[0],
            ...
            return t.prototype.clickPrevButton = function () {
                ...
                t.prototype.prevArrowCss = function () {
                    var t, e;
                    return t = this.firstDate().clone().subtract(1, "millisecond"),
                        "day" !== (e = this.period()) && "week" !== e || (t = t.endOf("month")),
                        {
                ...
                t.prototype.nextArrowCss = function () {
                    var t, e, n, a, r;
                    return n = this.period.dimentions(),
                        t = n[0],
                        r = n[1],
                        e = this.firstDate().clone().add(t * r, this.period()),
                        "day" !== (a = this.period()) && "week" !== a || (e = e.startOf("month")),
                        {
                ...
                t.prototype.monthOptions = function () {
                    var t, e, n;
                    return e = this.currentDate.minBoundary().isSame(this.currentDate(), "year") ? this.currentDate.minBoundary().month() : 0,
                        t = this.currentDate.maxBoundary().isSame(this.currentDate(), "year") ? this.currentDate.maxBoundary().month() : 11,
                        function () {
                            n = [];
                ...
                t.prototype.decadeOptions = function () {
                    return e.uniqArray(this.yearOptions().map(function (t) {
                        return function (e) {
                            var n;
                            return n = u.tz([e], t.timeZone()),
                                t.firstYearOfDecade(n).year()
                        }
                    }(this)))
                },
        ...
        a = function () {
            function t(t, e, a) {
                this.cssForDate = p(this.cssForDate, this),
                        ...
                        return function () {
                            ...
                            switch (e = t.currentDate().clone().startOf(t.period.scale()), t.period()) {
                                ...
                                case "week":
                                    n = e.clone(),
                                        e.weekday(0),
                                        (e.isAfter(n) || e.isSame(n, "day")) && e.subtract(1, "week");
                                    break;
                                case "year":
                    ...
                    this.activeDate.subscribe(function (t) {
                        return function (e) {
            ...
            return t.prototype.calendar = function () {
                ...
                for (i = this.period.dimentions(), e = i[0], d = i[1], a = new c(this.firstDate(), this.period()), s = [], u = r = 1, o = d; 1 <= o ? r <= o : r >= o; u = 1 <= o ? ++r : --r) s.push(function () {
                    var r, i, o;
                    for (o = [], t = r = 1, i = e; 1 <= i ? r <= i : r >= i; t = 1 <= i ? ++r : --r) n = a.next(),
                        "end" === this.type ? o.push(n.endOf(this.period())) : o.push(n.startOf(this.period()));
                    return o
                }.call(this));
                return s
            },
                ...
                t.prototype.tableValues = function (t) {
                    ...
                    switch (e = this.period.format(), this.period()) {
                        ...
                        case "week":
                            return t = t.clone().startOf(this.period()),
                                c.array(t, 7, "day").map(function (t) {
                                    return function (n) {
                                        return {
                                            html: n.format(e),
                                            css: {
                ...
                t.prototype.cssForDate = function (t, e) {
                    var n, a, r, i, o;
                    return i = t.isSame(this.activeDate(), this.period()),
                        ...
                        r[this.type + "-date"] = i,
                        r.clickable = o,
                        r["out-of-boundaries"] = !o,
                        r.unavailable = e && n,
                        r
                },
                t.prototype.firstYearOfDecade = function (t) {
                    var e, n, a, r;
                    return e = u.tz(moment(), this.timeZone()).year(),
                        n = e - 4,
        ...
        s = function () {
            function t(t) {
                ...
                null == t && (t = {}),
                    ...
                    this.startDate.subscribe(function (t) {
                        return function (e) {
                    ...
                    this.callback && (this.dateRange.subscribe(function (t) {
                        return function (e) {
                            var n, a;
                            return a = e[0],
                                n = e[1],
                    ...
                    }(this)), this.forceUpdate && (n = this.dateRange(), i = n[0], e = n[1], this.callback(i.clone(), e.clone(), this.period()))),
                    this.anchorElement && (o = $('<div data-bind="stopBinding: true"></div>').appendTo(this.parentElement), this.containerElement = $(this.constructor.template).appendTo(o), ko.applyBindings(this, this.containerElement.get(0)), this.anchorElement.click(function (t) {
                        return function () {
                            return t.updatePosition(),
                                t.toggle()
                        }
                    }(this)), this.standalone() || $(document).on("mousedown.daterangepicker", this.outsideClick).on("touchend.daterangepicker", this.outsideClick).on("click.daterangepicker", "[data-toggle=dropdown]", this.outsideClick).on("focusin.daterangepicker", this.outsideClick)),
                    this.opened() && this.updatePosition()
            }
            return t.prototype.periodProxy = d,
                ...
                t.prototype.cssClasses = function () {
                    ...
                    for (n = {
                        ...
                        "hide-periods": 1 === this.periods().length,
                        "orientation-left": "left" === this.orientation(),
                        "orientation-right": "right" === this.orientation()
                    },
                        r = d.allPeriods, t = 0, e = r.length; t < e; t++) a = r[t],
                            n[a + "-period"] = a === this.period();
                    return n
                },
                ...
                t.prototype.isActiveDateRange = function (t) {
                    var e, n, a, r;
                    if (t.constructor === i) {
                        for (r = this.ranges, n = 0, a = r.length; n < a; n++) if (e = r[n], e.constructor !== i && this.isActiveDateRange(e)) return !1;
                        return !0
                    }
